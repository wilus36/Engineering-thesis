#Przejścia 1-3, seria 1, łańcuch X8
...
plik1='X8-1-1'                            #określenie wybranej grupy danych
...
z1=(z1-2048)*(500/2048)+1.8               #wyrównanie wykresu do 0 i kompensacja błędu kalibracji profilografu
...
z3=(z3-2048)*(500/2048)-43.4
ni3=z3.size
i3=pylab.arange(ni3)*(4/ni3)*1000
pylab.plot(i3,z3,color='g',label=plik3)
 
pylab.grid()                                                           #dodanie siatki
pylab.title(u'Łańcuch 8-rzędowy, seria 1',size='large')                #dodanie tytułu wykresu
