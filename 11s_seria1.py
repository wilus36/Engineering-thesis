#Przejścia 1-3, seria 1, łańcuch X11
...
plik1='X11-1-1'                           #określenie wybranej grupy danych
...
z1=(z1-2048)*(500/2048)+5                 #wyrównanie wykresu do 0 i kompensacja błędu kalibracji profilografu
ni1=z1.size                               #odczyt rozmiaru macierzy
i1=pylab.arange(ni1)*(4/ni1)*1000         #ustawienie zakresu pomiaru
pylab.plot(i1,z1,color='r',label=plik1)   #utoprzenie wykresu
...
z3=(z3-2048)*(500/2048)+17.5
ni3=z3.size
i3=pylab.arange(ni3)*(4/ni3)*1000
pylab.plot(i3,z3,color='g',label=plik3)
 
pylab.grid()                                                           #dodanie siatki
pylab.title(u'Łańcuch 11-rzędowy, seria 1',size='large')               #dodanie tytułu wykresu
